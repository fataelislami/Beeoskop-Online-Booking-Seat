...
class Transaksi extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/transaksi/transaksi_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/transaksi/transaksi_form',
        ...
        'action'=>'{namamodule}/transaksi/create_action'
       );
      $this->template->load($data);
    }
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/transaksi/transaksi_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/transaksi/update_action',
        'dataedit'=>$dataedit
       );
      $this->template->load($data);
    }
    ...
    public function create_action()
    {
		...
		'username' => $this->input->post('username',TRUE),
            ...
            redirect(site_url('{namamodule}/transaksi'));
        }
    }
