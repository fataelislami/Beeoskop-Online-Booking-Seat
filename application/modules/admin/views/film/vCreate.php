  ...
  <div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-material m-t-40" method="post" action="<?php echo base_url() ?>admin/film/create_action" enctype="multipart/form-data">
               <!-- //START -->
                ...
                <div class="form-group" id="genre1">
