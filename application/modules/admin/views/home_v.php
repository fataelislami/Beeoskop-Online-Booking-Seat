            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <h6 class="card-subtitle">March  2018</h6> </div>
                </div>
                <div class="row">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <ul class="list-inline">
                        <li>
                            <h6 class="text-success"><i class="fa fa-circle font-10 m-r-10 "></i>Cimahi</h6> </li>
                        <li>
                            <h6 class="text-info"><i class="fa fa-circle font-10 m-r-10"></i>Bandung Kota</h6> </li>
                        <li>
                            <h6 class="text-danger"><i class="fa fa-circle font-10 m-r-10"></i>Bandung Barat</h6> </li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Film Terbaru</h4>
                <div class="table-responsive m-t-20">
                    <table class="table stylish-table">
                        <thead>
                            <tr>
                                <th colspan="2">Sutradara</th>
                                <th>Judul Film</th>
                                <th>Studio</th>
                                <th>Jadwal</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><h6>fataelislami</h6><small class="text-muted">Creator</small></td>
                                <td>Kolam Renang Cihuy</td>

                                <td><span class="label label-success">Bandung</span></td>
                                <td>15.30</td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="card earning-widget">
            ...
            <div class="card-body b-t collapse show">
                <table class="table v-middle no-border">
                    <tbody>
                        <tr>
                            <td style="width:40px"><img src="URLFOTO" width="50" class="img-circle" alt="logo"></td>
                            <td>Fajar I</td>
                            <td align="right"><span class="label label-light-info">3</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
