            ...
            <div class="card-body">
              <div class="row">
                  <div class="col-md-6">
                      ...
                      <h6 class="card-subtitle">Pengelolaan Data Genre</h6>
                  </div>
                  <div class="col-md-6 text-right">
                      <?php echo anchor(site_url($module.'/genre/create'), '+ Tambah Data', 'class="btn btn-primary"'); ?>
      	    </div>
              </div>
                        ...
                        <tbody>
                          <?php foreach ($datagenre as $d): ?>
                            <tr>
                              ...
                              <?php endforeach; ?>
                                <td>
                                <a href="<?php echo base_url().$module?>/genre/edit/<?php echo $d->id_genre ?>">
                                        <button class="btn btn-success waves-effect waves-light m-r-10">Edit</button>
                                    </a>
                                    <a href="<?php echo base_url().$module?>/genre/delete/<?php echo $d->id_genre ?>">
